...
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL ?? 'https://leader-next.com/api/v1';

/** Must match the domain configured in the admin backend for this website. */
export const WEBSITE_DOMAIN = process.env.NEXT_PUBLIC_WEBSITE_DOMAIN ?? 'leader-next.com';
